namespace CTPSYSTEM.Domain.Enumeradores
{
    ...
    /// </summary>
    public static class EstadoNome
    {
        ...
        public const string Goiás = "Goiás";
        public const string Maranhão = "Maranhão";
        public const string MatoGrosso = "Mato Grosso";
        public const string MatoGrossoSul = "Mato Grosso do Sul";
        ...
        public const string Piaui = "Piauí";
        public const string Roraima = "Roraima";
        public const string Rondonia = "Rondônia";
        public const string RioJaneiro = "Rio de Janeiro";
        public const string RioGrandeNorte = "Rio Grande do Norte";
        public const string RioGrandeSul = "Rio Grande do Sul";
